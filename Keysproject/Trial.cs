    ...
    class Trial
    {
       ...
       // [Test]
        public void TrialFun()
        {
            ...
            //click on menu        
            driver.FindElement(By.XPath("/html/body/div[1]/div/div[2]/div[1]")).Click(); // click on owners
            Thread.Sleep(1000);
            ...
            driver.FindElement(By.XPath("//*[@id='main-content']/div/div[1]/div/div[1]/fieldset/div[2]/div/div/div[2]/a[2]")).Click(); // click on Add property
                                                                                                                                       //property details
            driver.FindElement(By.Id("PropertyName")).SendKeys("RoseCottage");
            driver.FindElement(By.XPath("//*[@id='property-details']/div[2]/div[2]/div/div[2]/div[1]")); // Type
            driver.FindElement(By.XPath("//*[@id='autocomplete'")); // Search address 
